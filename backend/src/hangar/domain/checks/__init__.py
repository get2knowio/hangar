...
and workflow-permissions-least-privilege) extended to **32** with nine best-practice
additions: CONTRIBUTING, dangerous-workflow, SBOM, signed-releases, binary-artifacts,
signed-commits, Docker-base-image-pinning, CI-runs-on-PR and Dependabot-security-updates.
